...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //Faço uma injeção de dependencia
        ...
        public void Seed()
        {
            //Verifica se o banco foi populado
            ...
            //Crio os departamentos
            Departament d1 = new Departament(1, "Eletronics");
            Departament d2 = new Departament(2, "Computers");
            Departament d3 = new Departament(3, "Games");
            Departament d4 = new Departament(4, "Books");

            //Crio os vendedores
            Seller s1 = new Seller(1, "Teste", "Teste@gmail.com",  7500.0, new DateTime(1996, 8, 23), d2);
            Seller s2 = new Seller(2, "Teste2", "Teste2@gmail.com",  5000, new DateTime(1976, 2, 23), d1);
            Seller s3 = new Seller(3, "Teste3", "Teste3@gmail.com",  6000.0, new DateTime(1999, 5, 23), d3);
            Seller s4 = new Seller(4, "Teste4", "Teste4@gmail.com",  3000.0, new DateTime(1987, 11, 23), d4);
            Seller s5 = new Seller(5, "Teste5", "Teste5@gmail.com",  2000.0, new DateTime(2000, 1, 6), d2);
            Seller s6 = new Seller(6, "Teste6", "Teste6@gmail.com", 4000.0, new DateTime(2001, 10, 6), d1);
            ...
            //Save as alterações no banco de dados
